...
function GlobalLayouts({ children }) {
    ...
    <div>
      ...
      <body className="bg-gray-50 dark:bg-[#EFEFEF]">
        ...
        <div id="application-sidebar-dark"
          className={`${showMenu ? "hs-overlay border  bg-[#136CA] dark:bg-gray-800 hs-overlay-open:translate-x-0 -translate-x-full hidden transition-all duration-300 transform "
          ...
          <div className="px-6 text-center">
            <Link to={"/"} className="flex-none text-xl text-center font-semibold text-white" aria-label="Brand">Gestor de horarios</Link>
          </div>

          <nav className="hs-accordion-group p-6 w-full flex flex-col flex-wrap " data-hs-accordion-always-open>
            <ul className="space-y-1.5">
              <li>
                <Link to={"/"} className="flex items-center gap-x-3 py-2 px-2.5 bg-[#0a5f9b] dark:bg-blue-700 text-sm text-white rounded-md">
              ...
              <li className="hs-accordion" id="users-accordion">
                <Link to={"/"} className="hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-white hs-accordion-active:hover:bg-transparent text-sm text-gray-50 rounded-md hover:bg-gray-800 hover:text-white">
                  <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              ...
              <li><Link to={"/"} className="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-50 rounded-md hover:bg-gray-800 hover:text-white-300">
                <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div onClick={() => { setSHowMenu(true); }} className=" border-none pt-0  mt-5 md:mt-0 md:ml-5 px-4 sm:px-6 md:px-8 md:pl-64 break-words">
          <div className=' w-full items-center gap-4 justify-end  p-2 hidden md:flex'>
            ...
            <span className='font-semibold text-lgtext-black'  >Murilo Santos</span>
          ...
          <div className='flex flex-col justify-between border min-h-[94vh]'>

            <div className=' border-gray-700 p-5 rounded-md min-h-[8vh] break-words flex flex-row'>
