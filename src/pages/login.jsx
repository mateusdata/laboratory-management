...
const Login = () => {
  ...
  <html className="h-full">
    {contextHolder}
    <body className="dark:bg-slate-900 bg-gray-100 flex h-full items-center py-16 min-h-screen">
                ...
                <div className="grid gap-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input  value={email} onChange={handleEmailChange} placeholder='Email' type="email" id="email" name="email" className="py-3 border-2 outline-none px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" required aria-describedby="email-error"/>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input  value={password} onChange={handlePasswordChange} placeholder='Senha' type="password" id="password" name="password"  className="py-3 border-2 outline-none px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"  required aria-describedby="password-error"/>
                      <div className="hidden absolute inset-y-0 end-0 flex items-center pointer-events-none pe-3">
                        <svg className="h-5 w-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                          <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                        </svg>
                  ...
                  <div className="flex justify-between items-center">
                      ...
                      <a className="text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">Criar conta?</a>
                    </div>
